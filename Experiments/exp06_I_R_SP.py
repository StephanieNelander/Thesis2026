...
def run_experiment():
    """
    Run experiment I_R_SP for all personas defined in personas.txt.

    Simulates 40 games per persona, each consisting of 50 LLM-generated spins
    with the one-armed bandit role and summarized stats, and records the results.
    Each persona must be on its own line in the format "{persona_num} Persona
    description...".
